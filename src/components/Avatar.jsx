...
export function Avatar(props) {
  ...
  const group = useRef();
  const { nodes, materials } = useGLTF("models/6551d5a55f919c5b8aeaca0e.gltf");
  ...
  jumpingDownAnimation[0].name = "JumpingDown";
  standingAnimation[0].name = "Standing";
  console.log(wavingAnimation);
  console.log(jumpingDownAnimation);
  console.log(standingAnimation);
  const { actions } = useAnimations(
    [wavingAnimation[0], jumpingDownAnimation[0], standingAnimation[0]],
    group
  );
  //   console.log(wavingAnimation);
  //   console.log(group);
...
useGLTF.preload("models/6551d5a55f919c5b8aeaca0e.gltf");
